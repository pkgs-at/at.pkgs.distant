...
public class Program implements Runnable {
	...
	public Program(String base, String server) {
		this.base = base;
		this.server = server;
		this.interval = 0L;
		this.respawn = false;
	...
	public int build(PrintStream console, String... arguments) {
		...
		try {
			...
			context = new LocalContext(
					Program.class.getPackage().getName() + ".ant");
			loader = context.getClassLoader();
			Thread.currentThread().setContextClassLoader(loader);
			runner = loader.loadClass(
	...
	public static void main(String... arguments) {
		...
		if (arguments.length < 2) {
			System.err.println("arguments: BASE_URL SERVER");
		}
		program = new Program(arguments[0], arguments[1]);
		program.run();
	}
